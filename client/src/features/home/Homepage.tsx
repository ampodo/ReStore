...
export default function Homepage() {
   ...
   return (
      ...
      <Slider {...settings}>
          ...
          <div className="bg-3">
              <img src="/images/hero3.png" alt="hero" style={{display: 'block',  width:'100%', maxHeight:570, backgroundSize: 'cover', backgroundAttachment: "fixed", backgroundRepeat: "no-repeat" }} />
          </div>
